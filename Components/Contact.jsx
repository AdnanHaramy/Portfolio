...
function Contact() {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_ombox92', 'template_7xj0dgk', form.current, 'MCxckxElBse-tDz97')
            .then((result) => {
                ...
                <div className="contact-left">
                    ...
                    <form ref={form} onSubmit={sendEmail}>
                        ...
                        <div className="form-group" >
                            ...
                            <input type="submit" name="user_email" placeholder="Your Message" className="input-button" />
                        </div>
                    </form>
                </div>
                <div className="contact-right">
                    ...
                    <div className="contact-logos">
                        ...
                        <Link href="https://www.linkedin.com/in/maher-haramy-38b101160/" passHref target="_blank" >
                            <Image src="/linkedin.svg" alt="Logo 2" width={50} height={50} className="logo" />
                        </Link>
                        <Link href="https://www.facebook.com/maher.haramy.2020" passHref target="_blank" >
                            <Image src="/facebook.svg" alt="Logo 3" width={50} height={50} className="logo" />
                        </Link>
                        <Image src="/whatsapp.svg" alt="Logo 4" width={50} height={50} className="logo" />
